export const testimonials = [
    ...
    {
        quote: "Working with Max has been a great experience. He consistently demonstrates strong technical skills, professionalism, and a proactive attitude toward solving problems. His collaboration and clear communication made teamwork smooth and productive, and his commitment to delivering quality results is truly commendable.",
        name: "Abraham Oluwaseyi Alimi",
        title: "Quality Assurance Tester",
        company: "Loiz Tours and Travels Ltd"
    },
    {
        quote: "Max is a resourceful person. He has always exceeded expectations all the times I've worked with him. He contributes meaningfully to the team at each point of development.",
        name: "Tochukwu Ali",
        title: "Frontend Developer",
        company: "VPay"
    },
    ...
    {
        quote: "Max is a technically sound developer with a solid grasp of programming paradigms and a thoughtful approach to problem-solving. I’ve had the pleasure of collaborating with him on multiple projects, and the results have been consistently exceptional. Timelines, specifications, and quality requirements always met. Working with him is always an amazing experience. He’s extremely thorough in his work, not only executing tasks efficiently but also contributing valuable suggestions that often elevate the entire project. What truly sets him apart, though, is his foresight. Max has an incredible ability to spot potential issues long before they surface. If he were on the Titanic, he’d have seen the iceberg miles away. Beyond his technical skills, Max is a great teammate. Open-minded, proactive, and reliable.",
        name: "Emmanuel Ejei-Okeke",
        title: "Frontend Developer",
        company: "Echezona Digital Solutions Ltd"
    }
];